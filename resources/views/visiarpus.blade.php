<x-layout.app title="Visi & Misi Dinas Arpusda Kota Semarang">
    <section class="vm-section" aria-label="Visi Misi Dinas Arpusda">
        <div class="container vm-container">
            ...
            <div class="vm-header">
                ...
                <h1 class="vm-title">Visi & Misi <span class="vm-accent">Dinas Arsip dan Perpustakaan</span></h1>
            </div>
            ...
            <div class="vm-grid">
                ...
                <div class="vm-left">
                    ...
                    <div class="vm-image-wrapper">
                        <img src="{{ asset($data['image']) }}" alt="Gedung Dinas Arsip dan Perpustakaan Kota Semarang" class="vm-image" loading="lazy">
                    </div>
                </div>
